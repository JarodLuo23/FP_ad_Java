...
<body>
  ...
  <!-- end site-menu -->
	...
	<!-- end mobile-menu -->
<nav class="navbar">
  <div class="logo"> <a href="index"> <img src="../../static/picture/logo.png" alt="Image"> </a> </div>
  <!-- end logo -->
  <div class="site-menu">
    <ul>
      <li><a href="index.jsp">HOME</a></li>
...
<main>
  <header class="page-header single" data-background="../../static/images/movie-poster-bg.jpg">
    <div class="container">
      <div class="row">
		<div class="col-12">
		  	<div class="video-player">
				<a href="index.jsp" class="back-btn"><i class="lni lni-chevron-left"></i> BACK</a>
			<video src="videos/video02.mp4" poster="images/movie-poster.jpg" controls playsinline></video>
			</div>
			<!-- end video-player -->
		  </div>
		  <!-- end col-12 -->
  ...
  <!-- end header -->
	<section class="content-section" data-background="static/images/movie-single.html#ffffff">
	<div class="container">
      <div class="row">
		<div class="col-lg-8">
			<div class="movie-info-box">
            <h2 class="name">Rise of Empires: <br>
              <strong>Ottoman</strong></h2>
            <ul class="features">
              <li>
                <div class="rate">
            ...
            <p class="description">A hardened mercenary's mission becomes a soul-searching 
race to survive when he's sent into Bangladesh to rescue a 
drug lord's kidnapped son.</p>
...
<a href="#"><i class="lni lni-thumbs-up"></i></a> <a href="#"><i class="lni lni-thumbs-down"></i></a> <strong>61% liked this film</strong></div>
		  ...
		  <div class="col-lg-4">
		  	<div class="movie-side-info-box">
				<figure><img src="../../static/picture/movies01.jpg" alt="Image"></figure>
			 <ul>
				<li><strong>Initial release: </strong> Sept 16, 2020</li>
...
<li><strong>Screenplay:</strong> Carles Torras</li>
	...
	<!-- end content-section -->
	<section class="content-section" data-background="static/images/movie-single.html#111111">
    <div class="container">
      <div class="row">
        <div class="col-12">
  ...
  <!-- end content-section -->
	<section class="content-section" data-background="static/images/movie-single.html">
	<div class="container">
	<div class="row">
		<div class="col-12">
		...
		<div class="col-12">
			<div class="comments">
				<ul class="comments-list">
					<li>
					<figure class="avatar"><img src="../../static/picture/avatar01.jpg" alt="Image"></figure>
				<div class="comment">
