	  ...
	  <div class="col-lg-8">
        ...
        <figure>
          ...
          <div class="content overlap"> <small>31 November, 2020</small>
            <h3><a href="tips-single.jsp">Exclusive: Santa Claus shares his list of must-watch ho-ho-holiday</a></h3>
        ...
        <!-- end news-box --> 
		    <div class="news-box">
        <figure>
			<img src="../../static/picture/news02.jpg" alt="Image">
			   </figure>
          <div class="content overlap"> <small>31 November, 2020</small>
            <h3><a href="tips-single.jsp">digiflex's spy thriller 'Munich' starring Jeremy Irons starts production </a></h3>
            <div class="author"> <img src="../../static/picture/avatar.jpg" alt="Image"> <span>by <b>digiflex</b></span> </div>
            <!-- end author --> 
			 </div>
			<!-- end content -->
        ...
        <!-- end news-box --> 
		    <div class="news-box">
        <figure>
			<img src="../../static/picture/news03.jpg" alt="Image">
			   </figure>
          <div class="content overlap"> <small>31 November, 2020</small>
            <h3><a href="tips-single.jsp">Supernatural Horror Series Archive 81 Starring Emmy Award Nominee </a></h3>
            <div class="author"> <img src="../../static/picture/avatar.jpg" alt="Image"> <span>by <b>digiflex</b></span> </div>
            <!-- end author --> 
			 </div>
			<!-- end content -->
        ...
        <!-- end news-box --> 
		  <div class="news-box">
        <figure>
			<img src="../../static/picture/news04.jpg" alt="Image">
			   </figure>
          <div class="content overlap"> <small>31 November, 2020</small>
            <h3><a href="tips-single.jsp">The world's leading streaming entertainment service, released axe</a></h3>
            <div class="author"> <img src="../../static/picture/avatar.jpg" alt="Image"> <span>by <b>digiflex</b></span> </div>
            <!-- end author --> 
			 </div>
			<!-- end content -->
        ...
        <!-- end news-box --> 
		  <div class="news-box">
        <figure>
			<img src="../../static/picture/news05.jpg" alt="Image">
			   </figure>
          <div class="content overlap"> <small>31 November, 2020</small>
            <h3><a href="tips-single.jsp">Every episode is a standalone story, but all are interconnected</a></h3>
            <div class="author"> <img src="../../static/picture/avatar.jpg" alt="Image"> <span>by <b>digiflex</b></span> </div>
            <!-- end author --> 
			 </div>
			<!-- end content -->
